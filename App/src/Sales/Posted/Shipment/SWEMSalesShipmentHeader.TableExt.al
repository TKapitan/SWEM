/// <summary>
/// TableExtension TKA SWEM Sales Shipment Header (ID 81005) extends Record Sales Shipment Header.
/// </summary>
tableextension 81005 "TKA SWEM Sales Shipment Header" extends "Sales Shipment Header"
{
    fields
    {
